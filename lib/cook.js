...
var BOOTSTRAP = {
    ...
    html: "http://feifeihang.info/cook/template/html5/index-bootstrap.html"
};
...
var fetchProjectStructure = function(project) {
    ...
    fetchFile({project: project, url: HTML.html_file, filename: project + '/index.html', callback: gruntInstall});
    ...
    // Bootstrap
    if(settings.bootstrap === 'Y' || settings.bootstrap === 'y') {
        fetchFile({project: project, url: BOOTSTRAP.html, filename: project + '/index.html', callback: gruntInstall});
    ...
    // Grunt
    if(settings.grunt === 'Y' || settings.grunt === 'y') {
        fetchFile({project: project, url: GRUNT.package_file + project, filename: project + '/package.json', callback: gruntInstall});
        fetchFile({project: project, url: GRUNT.gruntfile_file, filename: project + '/Gruntfile.js', callback: gruntInstall});
    }
};
