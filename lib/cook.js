...
var fetchProjectStructure = function(project) {
    ...
    if(settings.requirejs === 'Y' || settings.requirejs === 'y') {
        ...
        createDirectory(project + '/dist/js/vendor');
        ...
        fetchFile({project: project, url: HTML.jquery_js, filename: project + '/dist/js/vendor/jquery.js', callback: gruntInstall});
        fetchFile({project: project, url: HTML.modernizr_js, filename: project + '/dist/js/vendor/modernizr.js', callback: gruntInstall});
        fetchFile({project: project, url: HTML.plugins_js, filename: project + '/dist/js/vendor/plugins.js', callback: gruntInstall});
    }
    else {
